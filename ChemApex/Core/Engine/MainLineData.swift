    ...
    private static let olympiadNodes: [LearningNode] = [
        LearningNode(
            ...
            knowledgePoints: [
                ...
                KnowledgePoint(
                    id: "kcap3", title: "热力学：ΔG 取代所有定性口诀",
                    detail: "高中靠「放热有利、熵增有利」定性猜方向，竞赛/大学用一条 ΔG = ΔH − TΔS 精确判断：ΔG<0 自发。ΔH<0、ΔS>0 永远自发；ΔH>0、ΔS<0 永远不自发；其余看温度。一个公式收编了高中所有零散结论。",
                    pitfall: "「需要加热才发生」不代表非自发——可能只是动力学慢（活化能高）。"),
                KnowledgePoint(
                    id: "kcap4", title: "杂化延伸 + 配合物",
                    detail: "高中杂化止于 sp³，竞赛延伸到 sp³d（三角双锥，如 PCl₅）、sp³d²（正八面体，如 SF₆），把各种怪构型都算明白。配合物：中心离子提供空轨道、配体提供孤对电子，配位数与杂化决定空间构型（[Cu(NH₃)₄]²⁺ 是平面正方形）。"),
                KnowledgePoint(
